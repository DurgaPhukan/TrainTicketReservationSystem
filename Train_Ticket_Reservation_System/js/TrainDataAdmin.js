...
function createTable(jsonStr) {
    ...
    function showBookingPage() {
        window.location.href = "http://127.0.0.1:5501/html/ticket.html";
    }
    function showEditPage(trainNo) {
        window.location.href = "http://127.0.0.1:5501/html/editTrain.html?id=" + trainNo;
    }
    function showDeletePage() {
        window.location.href = "http://127.0.0.1:5501/html/deletetrain.html";
    }
}
